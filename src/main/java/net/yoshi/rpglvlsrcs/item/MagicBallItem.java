...
public class MagicBallItem extends RpgLvlsRcsModElements.ModElement {
	@ObjectHolder("rpg_lvls_rcs:magic_ball")
	public static final Item block = null;
	public MagicBallItem(RpgLvlsRcsModElements instance) {
		super(instance, 11);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("magic_ball"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(RPGLvlsRcsItemGroup.tab).maxDamage(10000));
		}
