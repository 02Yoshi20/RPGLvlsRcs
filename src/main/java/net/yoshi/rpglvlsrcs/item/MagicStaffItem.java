...
public class MagicStaffItem extends RpgLvlsRcsModElements.ModElement {
	@ObjectHolder("rpg_lvls_rcs:magic_staff")
	public static final Item block = null;
	public MagicStaffItem(RpgLvlsRcsModElements instance) {
		super(instance, 15);
	}
	...
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(RPGLvlsRcsItemGroup.tab).maxDamage(100000));
		}
