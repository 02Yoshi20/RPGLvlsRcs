...
public class MagicCrystalItem extends RpgLvlsRcsModElements.ModElement {
	@ObjectHolder("rpg_lvls_rcs:magic_crystal")
	public static final Item block = null;
	public MagicCrystalItem(RpgLvlsRcsModElements instance) {
		super(instance, 2);
	}
